...
AST_NodeLet *alloc_let_stmt(String_View name, AST_Node *initializer, bool has_initializer, bool constant) {
...
AST_Node *parse_str(Lexer *l) {
    ...
    val.as_str = sv_to_escaped_sb(l->cur.val);
